...
- Clonar en una carpeta de su preferencia el repositorio: `https://github.com/Misael10Z/Incuba-Academy-MA.git`.
...
2. Navegar hasta la ruta `Incuba-Academy-MA\Módulo 1 - Fundamentos Web, APIs y JSON\Nivel 2 - Aplicación\lab-02`:
   ...
   1. **Terminal del OS:**
      ...
      1. Navega primero al disco donde hayas clonado el repositorio escribiendo solamente la letra de su identificación y dos puntos.
         Ejemplo: `d:`.
      2. Luego, dirígete a la ruta principal del script con el comando `cd`.
         Ejemplo:
   ...
   2. **Terminal del IDE:**
      ...
      1. Abra la carpeta `lab-02` que contiene el script mediante el explorador de su IDE para que actualice automáticamente la ruta de la terminal o en su defecto a través de la misma terminal como en lo redactado en el punto 2.a..
